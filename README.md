...
2. Le système recherche des documents pertinents (retrieval)
3. Les informations sont injectées dans le modèle
4. Le modèle génère une réponse contextualisée